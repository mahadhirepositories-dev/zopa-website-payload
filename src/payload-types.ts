...
export interface ContentBlock {
  columns?:
    | {
        size?: ('oneThird' | 'half' | 'twoThirds' | 'full' | 'oneQuarter') | null;
        style?: ('default' | 'stat') | null;
        richText?: {
          root: {
            type: string;
            children: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "Product_flux_select".
 */
export interface ProductFluxSelect<T extends boolean = true> {
  heading?: T;
  title?: T;
  description?: T;
  features?:
